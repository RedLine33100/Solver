...
public class SolverDouble extends Calcul<Double> {
    ...
    public SolverDouble(Variable<Double> prev) {
        super(prev, null);
    }
    ...
    SolverDouble(Variable<Double> previous, Triplet<BinaryOperator<Double>, BinaryOperator<Double>, Variable<Double>> calcul) {
